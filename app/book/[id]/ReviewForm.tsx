...
export default function ReviewForm({bookId} : {bookId: string}) {
  ...
  return (
    <form className="mb-10 p-5 py-8 border border-neutral-300 mx-auto rounded-md sticky top-10">
      ...
      <div className="mb-10">
        ...
        <textarea id="message" rows={4} onChange={(e) => setContent(e.target.value)} className="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Overall, it is a great book..." required></textarea>
      </div>
